...
public enum L2CognitiveToolPolicy {
    ...
    /// Public observation schemas contain only semantic arguments. The trusted
    /// local gateway supplies the policy envelope after authenticating the
