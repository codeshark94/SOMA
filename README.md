...
| **L0.5 · local semantic helper** | Sparse asynchronous visual inference, temporal evidence integration, and current-turn tool advice | Produces evidence deltas for L1 and one validated advisory for L2 without blocking L0 | No independent motor, tool-execution, speech, identity, memory, or wake authority |
